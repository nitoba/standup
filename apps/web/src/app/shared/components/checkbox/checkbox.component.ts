  ...
  template: `
    <main class="relative flex" zardId="checkbox" #z="zardId">
      ...
      <z-icon
        zType="check"
        [class]="
          'text-black pointer-events-none absolute top-1/2 left-1/2 flex -translate-1/2 items-center justify-center transition-opacity ' +
...
export class ZardCheckboxComponent implements ControlValueAccessor {
  ...
  readonly checked = this.zChecked.asReadonly()
